...
<!--Popup form start-->
  ...
  <!--Popup form end-->
  <h2>Welcome to user edit information page</h2>
              ...
              <div class="card mb-3 ">
                  <div class="card-body" style="height: 250px">
                      ...
                      <div style="text-align:center ;">
                         <img class="mySlides" src="./Image/<?php echo $row1['photo'];?>" style="border-radius: 50% ;height: 120px;width:150px"><b>  Hii <?php echo $row1['username'];?></b>
                      </div>
                  </div>
              </div>
              ...
              <div class="card mb-3 ">
                  <div class="card-body" >
                    <div style="text-align: center;">
                        ...
                        <div style="text-align: right;">Add Photo: <input type="file" name="photo"></div><br>
                    </div>
                    <form id="saveinfodata">
                      <div>Name: <input type="text" value="<?php echo $row1['name'];?>" name="name"></div><hr><br>
                      <div>Last name: <input type="text" value="<?php echo $row1['lastname'];?>" name="lastname"></div><hr><br>
                      <div>Date of Birth: <input type="text" value="<?php echo $row1['udob'];?>" name="udob"></div><hr><br>
                      <div>Gander: <input type="text" value="<?php echo $row1['gander'];?>" name="gander"></div><hr><br>
                      <div>Mobile No: <input type="text" value="<?php echo $row1['umob'];?>" name="mobileno"></div><hr><br>
                      <div>Email Address: <input type="text" value="<?php echo $row1['uemail'];?>" name="email"></div><hr><br>
                      <div><b>Address:</b>
                        <div>Village/Area: <label><input type="text" value="<?php echo $row1['village'];?>" name="village"></label></div>
                        <div>Town: <label><input type="text" value="<?php echo $row1['town'];?>" name="town"></label></div>
                        <div>Pin No: <label><input type="number" value="<?php echo $row1['pinno'];?>" name="pinno"></div>
                        <div>District: <label><input type="text" value="<?php echo $row1['district'];?>" name="district"></label></div>
                        <div>State: <label><input type="text" value="<?php echo $row1['state'];?>" name="state"></label></div>
                      </div>
                      <button type="submit" class="btn btn-info saveinfo" id="saveinfo" name="Submit">Save</button>
                    </form>
                  </div>
              </div>
              <script>
                $(document).ready(function(){
                  $("#saveinfo").click(function(){
                    $.ajax({
                      url:"edit_information.php",
                      type:"post",
                      data:$("#saveinfodata").serialize(),
                      beforeSend:function(){
                        $("#load").html('<span class="text-info">Loading...</span>')
                      },
